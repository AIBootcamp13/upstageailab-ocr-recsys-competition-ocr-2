...
**Generated:** 2025-10-07 16:51:38
**WandB Run:** [baseline_profiling_2025_10_07_v2](https://wandb.ai/runs/mtocs2zh)
**Run ID:** `mtocs2zh`
**Status:** finished
...
| **Number of Batches** | 0 |
| **Mean Batch Time** | 0.0ms |
| **Median Batch Time** | 0.0ms |
| **P95 Batch Time** | 0.0ms |
| **P99 Batch Time** | 0.0ms |
| **Batch Time Std Dev** | 0.0ms |
...
```json
{
  ...
  "paths": {
    "log_dir": "outputs/baseline_profiling_2025_10_07_v2/logs",
    "checkpoint_dir": "outputs/baseline_profiling_2025_10_07_v2/checkpoints",
    "submission_dir": "outputs/baseline_profiling_2025_10_07_v2/submissions"
  },
  "wandb": true,
  "logger": {
    "wandb": {
  ...
  "exp_name": "baseline_profiling_2025_10_07_v2",
  "callbacks": {
