...
from .models.config import SliderConfig
...
class InferenceState:
    ...
    processed_images: dict[str, set[str]] = field(default_factory=dict)
    ...
    def from_session(cls) -> InferenceState:
        ...
        return cls(
            ...
            processed_images={k: set(v) for k, v in state.processed_images.items()},
    ...
    def persist(self) -> None:
        ...
        st.session_state.processed_images = {k: set(v) for k, v in self.processed_images.items()}
    ...
    def ensure_processed_bucket(self, model_path: str) -> None:
        self.processed_images.setdefault(model_path, set())
